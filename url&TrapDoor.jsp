...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>URL &amp; Digital Artifacts... </span></h2>
          <div class="clr"></div>
          
       
          <div class="clr"></div>
          <p class="style3"><span class="style5">URL is</span> : <span class="style4"><%=request.getParameter("url")%></span></p>
          <p class="style3"><span class="style5">Hash Code is:</span> <span class="style4"><%=request.getParameter("td")%>          </span></p>
        
		<%
		String sha=request.getParameter("att");
		if(sha.equalsIgnoreCase("att"))
       {		%>
				  <p align="right"><a href="attackers.jsp">Back</a></p>
				  <%
				  }
				 else{
				  %><p align="right"><a href="viewAllDataOwnersFiles.jsp">Back</a></p><%
				  }
				  %>
        </div>
