...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <p>
	   <form id="form1" name="form1" method="post" action="topN1.jsp">
           <p align="center"><span class="style5"><span class="style8">Enter The Coun</span>t </span>
            <input required="required" name="t14" type="text" value="" size="40" /></p>
            <p align="center"><input type="submit" name="Submit2" value="FIND TOP N" /></p>
