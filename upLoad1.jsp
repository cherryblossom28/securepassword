...
%>
		  <form action="upLoad2.jsp" method="post">
            ...
            <tr>
              <td width="189" height="35" bgcolor="#FF0000"><div align="center" class="style6"><span class="style3">File Name  </span></div></td>
            ...
            <tr>
              ...
              <td><div align="center">
                <textarea name="text2" cols="50" rows="15" readonly><%= encryptedValue %></textarea>
              </div></td>
            </tr>
            <tr>
              <td height="35" bgcolor="#FF0000"><div align="center" class="style6"><span class="style3">Hash Code </span></div></td>
              <td><div align="center">
                <input name="t4" type="text" id="t4" size="50" value="<%= h1 %>" readonly="readonly" />
              </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
